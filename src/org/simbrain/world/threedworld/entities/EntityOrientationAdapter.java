...
public class EntityOrientationAdapter {
    ...
    public static AttributeType getProducerType(WorkspaceComponent component) {
        producerAttribute = new AttributeType(component, "Entity", "getOrientation", double.class, true);
        return producerAttribute;
    }
    
    public static AttributeType getConsumerType(WorkspaceComponent component) {
        consumerAttribute = new AttributeType(component, "Entity", "setOrientation", double.class, true);
        return consumerAttribute;
    }
    
    private Entity entity;
    
    EntityOrientationAdapter(Entity entity) {
        this.entity = entity;
    }
    ...
    private float[] getAngles() {
        return entity.getOrientation().toAngles(null);
    }
    
    private void setAngles(float[] angles) {
        Quaternion orientation = entity.getOrientation();
    ...
    private PotentialProducer createPotentialProducer(AttributeManager attributeManager, String dimension) {
        ...
        producer.setCustomDescription("Entity:getOrientation:" + dimension);
        return producer;
    }
    ...
    private PotentialConsumer createPotentialConsumer(AttributeManager attributeManager, String dimension) {
        ...
        consumer.setCustomDescription("Entity:setOrientation:" + dimension);
        return consumer;
    }
}