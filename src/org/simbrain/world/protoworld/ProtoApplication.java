 ...
 *
 */
public abstract class ProtoApplication extends Application {
    ...
    public ProtoApplication() {
        this(/*new StatsAppState(), */new ProtoCamAppState(), new DebugKeysAppState());
    }
    
    public ProtoApplication(AppState... initialStates) {
        super();
    ...
    public void initialize() {
        ...
        if (inputManager != null) {
            ...
            if (stateManager.getState(ProtoCamAppState.class) != null) {
                flyCam = new FlyByCamera(cam);
                flyCam.setMoveSpeed(1f); // odd to set this here but it did it before
                stateManager.getState(ProtoCamAppState.class).setCamera(flyCam);
            }
